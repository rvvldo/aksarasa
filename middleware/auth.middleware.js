const verifikasiToken = (req, res, next) => {
    ...
    try {
        ...
        return res.status(403).json({ message: "Token tidak valid" }); //apabila token tidak valid maka akan return json dan status 403
    } 
}